...
1. There are some categorical values which are not listed in the attribute information 
    e.g. Education 0 (not listed), 5 (unknown), 6 (unknown)
           Marital Status 0  (not listed)
     I may decide to safely put them under "Other" category or exclude them since they are few in number.
